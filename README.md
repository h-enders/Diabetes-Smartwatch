...
- `data_processing_scripts/vitalGlucProcessData8Min.py`:
  - Similar to above but uses larger sampling window and takes more samples

- `data_processing_scripts/processData.py` / `processDataPPG.py`:
